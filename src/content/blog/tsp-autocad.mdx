...
heroImage: "/assets/images/blog/tsp-autocad/portada.webp"
---
...
">
  <thead>
    <tr style="background-color: #f8f8f8;">
      <th style="width: 33.33%; padding: 0.3em; border: 1px solid #ccc; text-align: center;">$n$</th>
      <th style="width: 33.33%; padding: 0.3em; border: 1px solid #ccc; text-align: center;">$n!$</th>
      <th style="width: 33.33%; padding: 0.3em; border: 1px solid #ccc; text-align: center;">$n^2 \cdot 2^n$</th>
    </tr>
  </thead>
  <tbody>
    {[
      ...
      <tr>
        <td style="padding: 0.25em; border: 1px solid #ccc; text-align: right;">{n}</td>
        <td style="padding: 0.25em; border: 1px solid #ccc; text-align: right;">{fact}</td>
        <td style="padding: 0.25em; border: 1px solid #ccc; text-align: right;">{approx}</td>
      </tr>
    ))}
  </tbody>
</table>
